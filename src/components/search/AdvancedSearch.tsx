...
export default function AdvancedSearch({ isOpen, onClose }: AdvancedSearchProps) {
  ...
  return (
    <div className="absolute top-full left-0 right-0 bg-white shadow-lg border-t border-gray-200 z-50 animate-slide-up">
            ...
            <>
                  ...
                  return (
                    ...
                    >
                      ...
                      <div className="flex-1 min-w-0">
                        <Typography variant="body-base" theme="black" weight="bold" className="mb-1 truncate">
                          {product.nom}
                        </Typography>
                        <Typography variant="caption2" theme="gray" className="mb-1">
                          {product.categorie}
                        </Typography>
                        <Typography variant="body-base" theme="primary" weight="bold">
              ...
              {results.length >= 8 && (
                <div className="p-4 border-t border-gray-200">
                  ...
                  >
                    <Typography variant="body-base" theme="primary" weight="medium">

...
import { FiMail, FiLock, FiUser, FiAlertCircle, FiArrowRight, FiCheck } from "react-icons/fi";
...
export default function RegisterPage() {
  ...
  const onSubmit: SubmitHandler<RegisterFormData> = async (data) => {
    ...
    if (data.password !== data.confirmPassword) {
      setError(wording.auth.register.passwordMismatch);
      showNotification(wording.auth.register.passwordMismatch, "error");
      setIsLoading(false);
      return;
    }
    ...
    try {
      ...
      if (result.user) {
        showNotification(wording.auth.register.success, "success");
        setTimeout(() => {
          router.push("/");
        }, 1000);
      }
        ...
        <div className="max-w-6xl mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="hidden lg:block space-y-8">
              <div className="relative h-[600px] bg-gradient-to-br from-primary/10 to-primary/5 overflow-hidden shadow-2xl">
                ...
                <AuthBenefits
                  title={wording.auth.register.benefits.title}
                  description={wording.auth.register.benefits.description}
                  benefits={wording.auth.register.benefits.items}
                />
              </div>
            </div>
              ...
              <div className="bg-white/80 backdrop-blur-lg shadow-2xl border border-gray-200/50 p-10 relative">
                ...
                <div className="text-center mb-10 mt-4">
                  ...
                  <Typography variant="h1" theme="black" weight="bold" className="mb-3">
                    {wording.auth.register.title}
                  </Typography>
                  <Typography variant="body-base" theme="gray">
                    {wording.auth.register.subtitle}
                  </Typography>
                </div>
                ...
                <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div>
                      <label htmlFor="firstName" className="block text-sm font-semibold text-gray-900 mb-2">
                        {wording.auth.register.firstName} *
                      </label>
                      <div className="relative group">
                        ...
                        <input
                          ...
                          placeholder={wording.auth.register.firstNamePlaceholder}
                          ...
                          aria-label={wording.auth.register.firstName}
                        />
                      </div>
                      {errors.firstName && (
                    ...
                    <div>
                      <label htmlFor="lastName" className="block text-sm font-semibold text-gray-900 mb-2">
                        {wording.auth.register.lastName} *
                      </label>
                      <div className="relative group">
                        <div className="absolute left-0 top-0 bottom-0 w-12 flex items-center justify-center border-r border-gray-300 bg-gray-50 group-focus-within:bg-primary/5 group-focus-within:border-primary transition-colors">
                          <FiUser className="text-gray-400 group-focus-within:text-primary transition-colors" size={20} />
                        ...
                        <input
                          ...
                          placeholder={wording.auth.register.lastNamePlaceholder}
                          className="w-full pl-14 pr-4 py-4 border-2 border-gray-300 focus:ring-2 focus:ring-primary focus:border-primary outline-none transition-all bg-white hover:border-gray-400"
                          aria-label={wording.auth.register.lastName}
                        />
                      </div>
                      {errors.lastName && (
                        <Typography variant="caption2" theme="red" className="mt-2 flex items-center gap-1">
                  ...
                  <div>
                    ...
                    <div className="relative group">
                      ...
                      <input
                        ...
                        placeholder={wording.auth.register.emailPlaceholder}
                        className="w-full pl-14 pr-4 py-4 border-2 border-gray-300 focus:ring-2 focus:ring-primary focus:border-primary outline-none transition-all bg-white hover:border-gray-400"
                        aria-label={wording.auth.register.email}
                      />
                    </div>
                    {errors.email && (
                      <Typography variant="caption2" theme="red" className="mt-2 flex items-center gap-1">
                  ...
                  <div>
                    <label htmlFor="password" className="block text-sm font-semibold text-gray-900 mb-2">
                      {wording.auth.register.password} *
                    </label>
                    <div className="relative group">
                      <div className="absolute left-0 top-0 bottom-0 w-12 flex items-center justify-center border-r border-gray-300 bg-gray-50 group-focus-within:bg-primary/5 group-focus-within:border-primary transition-colors">
                      ...
                      <input
                        ...
                        placeholder={wording.auth.register.passwordPlaceholder}
                        className="w-full pl-14 pr-4 py-4 border-2 border-gray-300 focus:ring-2 focus:ring-primary focus:border-primary outline-none transition-all bg-white hover:border-gray-400"
                        aria-label={wording.auth.register.password}
                      />
                    </div>
                    ...
                    {password && (
                      <div className="mt-2">
                        <div className="flex items-center gap-2 mb-1">
                          ...
                          {passwordStrength && (
                            <Typography variant="caption2" theme="black" className="text-xs">
                  ...
                  <div>
                    <label htmlFor="confirmPassword" className="block text-sm font-semibold text-gray-900 mb-2">
                      {wording.auth.register.confirmPassword} *
                    </label>
                    <div className="relative group">
                      <div className="absolute left-0 top-0 bottom-0 w-12 flex items-center justify-center border-r border-gray-300 bg-gray-50 group-focus-within:bg-primary/5 group-focus-within:border-primary transition-colors">
                        <FiLock className="text-gray-400 group-focus-within:text-primary transition-colors" size={20} />
                      ...
                      <input
                        ...
                        {...register("confirmPassword", {
                          required: wording.auth.errors.required,
                          validate: (value) =>
                            value === password || wording.auth.register.passwordMismatch,
                        })}
                        placeholder={wording.auth.register.confirmPasswordPlaceholder}
                        className="w-full pl-14 pr-4 py-4 border-2 border-gray-300 focus:ring-2 focus:ring-primary focus:border-primary outline-none transition-all bg-white hover:border-gray-400"
                        aria-label={wording.auth.register.confirmPassword}
                      />
                    </div>
                      ...
                      <div className="mt-2">
                        {confirmPassword === password ? (
                          <div className="flex items-center gap-2 text-green-600">
                            <FiCheck size={16} />
                            <Typography variant="caption2" theme="black" className="text-green-600">
                          ...
                          <div className="flex items-center gap-2 text-red-600">
                            ...
                            <Typography variant="caption2" theme="black" className="text-red-600">
                    ...
                    <span className="relative z-10 flex items-center justify-center gap-2">
                      {isLoading ? (
                        <>
                          ...
                          {wording.auth.register.loading}
                        </>
                      ) : (
                        <>
                          {wording.auth.register.submit}
